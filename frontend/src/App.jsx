...
const Dashboard = () => {
  ...
  return (
    <AdminLayout title="Dashboard Home">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100/50 p-6 rounded-2xl mb-10 text-center sm:text-left shadow-sm mt-4 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 h-full opacity-[0.03] pointer-events-none transform translate-x-12 -translate-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <Link to="/dashboard/buses" className="bg-white p-6 rounded-2xl border border-gray-100 cursor-pointer hover:border-blue-200 hover:shadow-md transition-all group block">
          ...
          <h3 className="font-bold text-gray-900">Manage Fleet</h3>
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">Assign buses and drivers dynamically to schedules.</p>
        </Link>
        ...
        <Link to="/dashboard/routes" className="bg-white p-6 rounded-2xl border border-gray-100 cursor-pointer hover:border-blue-200 hover:shadow-md transition-all group block">
          ...
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">Configure dropoff points and align timing metrics.</p>
        </Link>
        ...
        <Link to="/dashboard/students" className="bg-white p-6 rounded-2xl border border-gray-100 cursor-pointer hover:border-blue-200 hover:shadow-md transition-all group block">
          ...
          <h3 className="font-bold text-gray-900">Allocations</h3>
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">Automatically assign students to capacities.</p>
        </Link>
        ...
        <Link to="/dashboard/attendance" className="bg-white p-6 rounded-2xl border border-gray-100 cursor-pointer hover:border-blue-200 hover:shadow-md transition-all group block">
          ...
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">Track student flow via QR check-ins actively.</p>
        </Link>
        ...
        <Link to="/dashboard/notifications" className="bg-white p-6 rounded-2xl border border-gray-100 cursor-pointer hover:border-blue-200 hover:shadow-md transition-all group block">
          ...
          <h3 className="font-bold text-gray-900">Push Alerts</h3>
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">Broadcast alerts to specific drivers and apps.</p>
        </Link>

        <Link to="/dashboard/complaints" className="bg-white p-6 rounded-2xl border border-gray-100 cursor-pointer hover:border-blue-200 hover:shadow-md transition-all group block">
          <div className="h-10 w-10 bg-gray-50 rounded-lg flex justify-center items-center mb-4 group-hover:bg-blue-50 transition-colors">
            <svg className="w-5 h-5 text-gray-600 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
          </div>
          <h3 className="font-bold text-gray-900">Issue Reports</h3>
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">Fix commute complaints and correct anomalies.</p>
        </Link>
      </div>
    </AdminLayout>
  );
